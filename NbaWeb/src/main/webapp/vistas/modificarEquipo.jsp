<%-- 
    ...
    Created on : 3 mar. 2023, 16:44:40
    Author     : carlo
--%>
...
<html>
    ...
    <body>
        ...
        <main>
            ...
            <form:form  action="modificarEquipo" modelAttribute="elEquipo" class="container">

                <div class="form_header">
                    <div class="image_container">
                        <img src="${elEquipo.imagen}" alt="logo actual" class="current"/>
